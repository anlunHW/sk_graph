...
public class G_heaps2_2 implements Runnable {
	public static void main(String[] args) {
		new Thread(new G_heaps2_2()).start();
	}
	...
	private final int maxHeapSize = 1000001;
	...
	private void work() {
		...
		alreadyCalculated = new int[maxHeapSize + 1];

		for (int i = 0; i < Math.min(minA, maxN); i++)
			//alreadyCalculated.put(i, 0);
			alreadyCalculated[i] = 0 + 1;
